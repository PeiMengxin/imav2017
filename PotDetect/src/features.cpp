...
MySVM get_svm(){
	...
	string svm_file_path="/home/odroid/catkin_ws/src/PotDetect/svm_pot_available.xml";
	//MySVM svm=ml::SVM::load(svm_file_path);
	MySVM svm=cv::Algorithm::load<cv::ml::SVM>("/home/odroid/catkin_ws/src/PotDetect/svm_pot_available.xml");
	return svm;
}
